...
const Constraint = Matter.Cnstraint;


function preload() {
  backgroundImage = loadImage("pro-c34+images\images/GamingBackground.png");
}
...
function mouseDragged() {
  Matter.Body.setPosition(suprhero.body, { x: mouseX, y: mouseY });
}
